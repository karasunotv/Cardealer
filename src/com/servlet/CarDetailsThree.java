...
/**
 * Servlet implementation class CarDetailsThree
 */
@WebServlet("/carDetailsThree")
public class CarDetailsThree extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CarDetailsThree() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Car myCar : Inventory.getCarList2()) {
			if(myCar.getId() == id)
			{
				...
				session2.setAttribute("myCar", myCar);
				break;
			}
		}
